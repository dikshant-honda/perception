...
if __name__ == "__main__":
    ...
    road_border = road_edges(cv2.imread("/home/dikshant/3D-Net-Monocular-3D-Object-Recognition-for-Traffic-Monitoring/code/tests/Road mask.bmp"))
    cv2.imwrite("Road Border.bmp", road_border)
